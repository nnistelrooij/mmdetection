...
def sigmoid_focal_loss(
    inputs, targets, num_boxes, weights=None, alpha: float=0.25, gamma: float=2, reduction: str='sum',
):
    """
    ...
    Args:
        ...
        reduction: Method for reducing sample losses.
                   Choose one of 'sum', 'mean', 'none'.
    Returns:
        Loss tensor
    """
    if inputs.numel() == 0:
