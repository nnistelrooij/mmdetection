...
data_root = '/home/mkaailab/.darwin/datasets/mucoaid/periapicals/'
data_root = '/home/mkaailab/.darwin/datasets/mucoaid/synmedico/'
split = 'synmedico_periapicals'
fold = 0
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        strict=False,
        # ann_file=data_root + f'val_{split}_{fold}.json',
        ann_file=data_root + f'releases/periapicals/other_formats/coco/output.json',
        data_prefix=data_prefix,
        data_root=data_root,
        metainfo=dict(classes=classes, attributes=attributes),
        pipeline=val_pipeline,
